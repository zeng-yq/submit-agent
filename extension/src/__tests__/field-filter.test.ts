...
describe('isHoneypotField', () => {
  let isHoneypotField: typeof import('@/agent/field-filter').isHoneypotField;
  ...
  beforeEach(async () => {
    ...
    const mod = await import('@/agent/field-filter');
...
describe('honeypotScore', () => {
  let honeypotScore: typeof import('@/agent/field-filter').honeypotScore;
...
describe('isVisible', () => {
  let isVisible: typeof import('@/agent/field-filter').isVisible;
